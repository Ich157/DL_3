...
def main():
    ...
    # with tarfile.open('./data_part3/mnist-varres.tgz', 'r:gz') as tar:
    # #     # Extract the contents of the .tgz file
    #     tar.extractall(path='./data_part3')

    # load and split data into train and val set
    train = torchvision.datasets.ImageFolder('./data_part3/mnist-varres/train', transform = transforms.Compose([transforms.Resize(size=(28,28)), transforms.ToTensor()]))
    test = torchvision.datasets.ImageFolder('./data_part3/mnist-varres/test', transform = transforms.Compose([transforms.Resize(size=(28,28)), transforms.ToTensor()]))
